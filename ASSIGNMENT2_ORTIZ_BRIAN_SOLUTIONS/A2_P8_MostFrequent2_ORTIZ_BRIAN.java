...
public class A2_P8_MostFrequent2_ORTIZ_BRIAN {

   public static String name = "ORTIZ_BRIAN";

// Using an array, this method must run in O(n) time.


   public static int mostFrequent2(int n, int [] A) {
...
//*********************************************************************
	...
	public static void main(String[] args)   {
      ...
      System.out.println("\n" + name);
      System.out.println("A2_P7_MostFrequnt2.");
      System.out.println("Using arrays, determine in LINEAR time the most frequent array element.");
